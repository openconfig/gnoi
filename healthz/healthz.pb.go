...
type ComponentStatus struct {
	...
	Healthz *any.Any `protobuf:"bytes,4,opt,name=healthz,proto3" json:"healthz,omitempty"`
}
...
func (x *ComponentStatus) GetHealthz() *any.Any {
	if x != nil {
		return x.Healthz
	}
	return nil
...
var file_healthz_healthz_proto_rawDesc = []byte{
	...
	0x6f, 0x62, 0x75, 0x66, 0x2f, 0x61, 0x6e, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x32,
