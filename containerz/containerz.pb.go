...
const file_github_com_openconfig_gnoi_containerz_containerz_proto_rawDesc = "" +
	...
	"\x05force\x18\x03 \x01(\bR\x05force\"\xbb\x01\n" +
	"\x13RemoveImageResponse\x12=\n" +
	"\x04code\x18\x01 \x01(\x0e2).gnoi.containerz.RemoveImageResponse.CodeR\x04code\x12\x16\n" +
	...
	"\bresponse\".\n" +
	"\aStartOK\x12#\n" +
	"\rinstance_name\x18\x01 \x01(\tR\finstanceName\"\xab\x01\n" +
	"\n" +
	"StartError\x12?\n" +
	"\n" +
	"error_code\x18\x01 \x01(\x0e2 .gnoi.containerz.StartError.CodeR\terrorCode\x12\x18\n" +
	"\adetails\x18\x02 \x01(\tR\adetails\"B\n" +
	"\x04Code\x12\x0f\n" +
	"\vUNSPECIFIED\x10\x00\x12\v\n" +
	"\aUNKNOWN\x10\x01\x12\r\n" +
	...
	"\arestart\x18\x03 \x01(\bR\arestart\"\xb1\x01\n" +
	"\x15StopContainerResponse\x12?\n" +
	"\x04code\x18\x01 \x01(\x0e2+.gnoi.containerz.StopContainerResponse.CodeR\x04code\x12\x18\n" +
	"\adetails\x18\x02 \x01(\tR\adetails\"=\n" +
	"\x04Code\x12\x0f\n" +
	"\vUNSPECIFIED\x10\x00\x12\b\n" +
	"\x04BUSY\x10\x01\x12\r\n" +
	"\tNOT_FOUND\x10\x02\x12\v\n" +
	"\aSUCCESS\x10\x03\"\xcf\x01\n" +
	...
	"\bis_async\x18\x02 \x01(\bR\aisAsync\"\xcf\x01\n" +
	"\vUpdateError\x12@\n" +
	"\n" +
	"error_code\x18\x01 \x01(\x0e2!.gnoi.containerz.UpdateError.CodeR\terrorCode\x12\x18\n" +
	"\adetails\x18\x02 \x01(\tR\adetails\"d\n" +
	"\x04Code\x12\x0f\n" +
	"\vUNSPECIFIED\x10\x00\x12\r\n" +
	"\tNOT_FOUND\x10\x01\x12\r\n" +
	"\tPORT_USED\x10\x02\x12\x0f\n" +
	"\vNOT_RUNNING\x10\x03\x12\x0f\n" +
	"\vNOT_UPDATED\x10\x04\x12\v\n" +
	"\aFAILURE\x10\x05\"I\n" +
	"\n" +
	"LogRequest\x12#\n" +
