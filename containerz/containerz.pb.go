...
type RemovePluginTarRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *RemovePluginTarRequest) Reset() {
	*x = RemovePluginTarRequest{}
	mi := &file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes[46]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RemovePluginTarRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RemovePluginTarRequest) ProtoMessage() {}

func (x *RemovePluginTarRequest) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes[46]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RemovePluginTarRequest.ProtoReflect.Descriptor instead.
func (*RemovePluginTarRequest) Descriptor() ([]byte, []int) {
	return file_github_com_openconfig_gnoi_containerz_containerz_proto_rawDescGZIP(), []int{46}
}

func (x *RemovePluginTarRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type RemovePluginTarResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *RemovePluginTarResponse) Reset() {
	*x = RemovePluginTarResponse{}
	mi := &file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes[47]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RemovePluginTarResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RemovePluginTarResponse) ProtoMessage() {}

func (x *RemovePluginTarResponse) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes[47]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RemovePluginTarResponse.ProtoReflect.Descriptor instead.
func (*RemovePluginTarResponse) Descriptor() ([]byte, []int) {
	return file_github_com_openconfig_gnoi_containerz_containerz_proto_rawDescGZIP(), []int{47}
}
...
func (x *ListImageRequest_Filter) Reset() {
	*x = ListImageRequest_Filter{}
	mi := &file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes[48]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *StartContainerRequest_Restart) Reset() {
	*x = StartContainerRequest_Restart{}
	mi := &file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes[54]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *StartContainerRequest_Limits) Reset() {
	*x = StartContainerRequest_Limits{}
	mi := &file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes[57]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ListVolumeRequest_Filter) Reset() {
	*x = ListVolumeRequest_Filter{}
	mi := &file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes[60]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_github_com_openconfig_gnoi_containerz_containerz_proto_rawDesc = "" +
	...
	"\x14RemovePluginResponse\",\n" +
	"\x16RemovePluginTarRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"\x19\n" +
	"\x17RemovePluginTarResponse*9\n" +
	"\x06Driver\x12\x12\n" +
	"\x0eDS_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bDS_LOCAL\x10\x01\x12\r\n" +
	"\tDS_CUSTOM\x10\x022\xc3\f\n" +
	"\n" +
	"Containerz\x12O\n" +
	...
	"\x0fRemovePluginTar\x12'.gnoi.containerz.RemovePluginTarRequest\x1a(.gnoi.containerz.RemovePluginTarResponse\"\x00B/\xd2>\x050.2.0Z%github.com/openconfig/gnoi/containerzb\x06proto3"
...
var file_github_com_openconfig_gnoi_containerz_containerz_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes = make([]protoimpl.MessageInfo, 63)
var file_github_com_openconfig_gnoi_containerz_containerz_proto_goTypes = []any{
	...
	(StartContainerRequest_Location)(0),        // 3: gnoi.containerz.StartContainerRequest.Location
	...
	(*RemoveImageRequest)(nil),                 // 13: gnoi.containerz.RemoveImageRequest
	(*RemoveImageResponse)(nil),                // 14: gnoi.containerz.RemoveImageResponse
	(*RemoveContainerRequest)(nil),             // 15: gnoi.containerz.RemoveContainerRequest
	(*RemoveContainerResponse)(nil),            // 16: gnoi.containerz.RemoveContainerResponse
	(*ListImageRequest)(nil),                   // 17: gnoi.containerz.ListImageRequest
	(*ListImageResponse)(nil),                  // 18: gnoi.containerz.ListImageResponse
	(*ListContainerRequest)(nil),               // 19: gnoi.containerz.ListContainerRequest
	(*ListContainerResponse)(nil),              // 20: gnoi.containerz.ListContainerResponse
	(*Volume)(nil),                             // 21: gnoi.containerz.Volume
	(*Device)(nil),                             // 22: gnoi.containerz.Device
	(*StartContainerRequest)(nil),              // 23: gnoi.containerz.StartContainerRequest
	(*StartContainerResponse)(nil),             // 24: gnoi.containerz.StartContainerResponse
	(*StartOK)(nil),                            // 25: gnoi.containerz.StartOK
	(*StartError)(nil),                         // 26: gnoi.containerz.StartError
	(*StopContainerRequest)(nil),               // 27: gnoi.containerz.StopContainerRequest
	(*StopContainerResponse)(nil),              // 28: gnoi.containerz.StopContainerResponse
	(*UpdateContainerRequest)(nil),             // 29: gnoi.containerz.UpdateContainerRequest
	(*UpdateContainerResponse)(nil),            // 30: gnoi.containerz.UpdateContainerResponse
	(*UpdateOK)(nil),                           // 31: gnoi.containerz.UpdateOK
	(*UpdateError)(nil),                        // 32: gnoi.containerz.UpdateError
	(*LogRequest)(nil),                         // 33: gnoi.containerz.LogRequest
	(*LogResponse)(nil),                        // 34: gnoi.containerz.LogResponse
	(*LocalDriverOptions)(nil),                 // 35: gnoi.containerz.LocalDriverOptions
	(*CustomOptions)(nil),                      // 36: gnoi.containerz.CustomOptions
	(*CreateVolumeRequest)(nil),                // 37: gnoi.containerz.CreateVolumeRequest
	(*CreateVolumeResponse)(nil),               // 38: gnoi.containerz.CreateVolumeResponse
	(*RemoveVolumeRequest)(nil),                // 39: gnoi.containerz.RemoveVolumeRequest
	(*RemoveVolumeResponse)(nil),               // 40: gnoi.containerz.RemoveVolumeResponse
	(*ListVolumeRequest)(nil),                  // 41: gnoi.containerz.ListVolumeRequest
	(*ListVolumeResponse)(nil),                 // 42: gnoi.containerz.ListVolumeResponse
	(*StartPluginRequest)(nil),                 // 43: gnoi.containerz.StartPluginRequest
	(*StartPluginResponse)(nil),                // 44: gnoi.containerz.StartPluginResponse
	(*StopPluginRequest)(nil),                  // 45: gnoi.containerz.StopPluginRequest
	(*StopPluginResponse)(nil),                 // 46: gnoi.containerz.StopPluginResponse
	(*ListPluginsRequest)(nil),                 // 47: gnoi.containerz.ListPluginsRequest
	(*Plugin)(nil),                             // 48: gnoi.containerz.Plugin
	(*ListPluginsResponse)(nil),                // 49: gnoi.containerz.ListPluginsResponse
	(*RemovePluginRequest)(nil),                // 50: gnoi.containerz.RemovePluginRequest
	(*RemovePluginResponse)(nil),               // 51: gnoi.containerz.RemovePluginResponse
	(*RemovePluginTarRequest)(nil),             // 52: gnoi.containerz.RemovePluginTarRequest
	(*RemovePluginTarResponse)(nil),            // 53: gnoi.containerz.RemovePluginTarResponse
...
var file_github_com_openconfig_gnoi_containerz_containerz_proto_depIdxs = []int32{
	...
	54, // 7: gnoi.containerz.ListImageRequest.filter:type_name -> gnoi.containerz.ListImageRequest.Filter
	55, // 8: gnoi.containerz.ListContainerRequest.filter:type_name -> gnoi.containerz.ListContainerRequest.Filter
	1,  // 9: gnoi.containerz.ListContainerResponse.status:type_name -> gnoi.containerz.ListContainerResponse.Status
	56, // 10: gnoi.containerz.ListContainerResponse.labels:type_name -> gnoi.containerz.ListContainerResponse.LabelsEntry
	71, // 11: gnoi.containerz.ListContainerResponse.hash:type_name -> gnoi.types.HashType
	2,  // 12: gnoi.containerz.Device.permissions:type_name -> gnoi.containerz.Device.Permission
	57, // 13: gnoi.containerz.StartContainerRequest.ports:type_name -> gnoi.containerz.StartContainerRequest.Port
	58, // 14: gnoi.containerz.StartContainerRequest.environment:type_name -> gnoi.containerz.StartContainerRequest.EnvironmentEntry
	21, // 15: gnoi.containerz.StartContainerRequest.volumes:type_name -> gnoi.containerz.Volume
	59, // 16: gnoi.containerz.StartContainerRequest.cap:type_name -> gnoi.containerz.StartContainerRequest.Capabilities
	60, // 17: gnoi.containerz.StartContainerRequest.restart:type_name -> gnoi.containerz.StartContainerRequest.Restart
	61, // 18: gnoi.containerz.StartContainerRequest.run_as:type_name -> gnoi.containerz.StartContainerRequest.RunAs
	62, // 19: gnoi.containerz.StartContainerRequest.labels:type_name -> gnoi.containerz.StartContainerRequest.LabelsEntry
	63, // 20: gnoi.containerz.StartContainerRequest.limits:type_name -> gnoi.containerz.StartContainerRequest.Limits
	22, // 21: gnoi.containerz.StartContainerRequest.devices:type_name -> gnoi.containerz.Device
	3,  // 22: gnoi.containerz.StartContainerRequest.location:type_name -> gnoi.containerz.StartContainerRequest.Location
	25, // 23: gnoi.containerz.StartContainerResponse.start_ok:type_name -> gnoi.containerz.StartOK
	26, // 24: gnoi.containerz.StartContainerResponse.start_error:type_name -> gnoi.containerz.StartError
	23, // 25: gnoi.containerz.UpdateContainerRequest.params:type_name -> gnoi.containerz.StartContainerRequest
	31, // 26: gnoi.containerz.UpdateContainerResponse.update_ok:type_name -> gnoi.containerz.UpdateOK
	32, // 27: gnoi.containerz.UpdateContainerResponse.update_error:type_name -> gnoi.containerz.UpdateError
	5,  // 28: gnoi.containerz.LocalDriverOptions.type:type_name -> gnoi.containerz.LocalDriverOptions.Type
	64, // 29: gnoi.containerz.CustomOptions.options:type_name -> gnoi.containerz.CustomOptions.OptionsEntry
	0,  // 30: gnoi.containerz.CreateVolumeRequest.driver:type_name -> gnoi.containerz.Driver
	65, // 31: gnoi.containerz.CreateVolumeRequest.labels:type_name -> gnoi.containerz.CreateVolumeRequest.LabelsEntry
	35, // 32: gnoi.containerz.CreateVolumeRequest.local_mount_options:type_name -> gnoi.containerz.LocalDriverOptions
	36, // 33: gnoi.containerz.CreateVolumeRequest.custom_options:type_name -> gnoi.containerz.CustomOptions
	66, // 34: gnoi.containerz.ListVolumeRequest.filter:type_name -> gnoi.containerz.ListVolumeRequest.Filter
	72, // 35: gnoi.containerz.ListVolumeResponse.created:type_name -> google.protobuf.Timestamp
	67, // 36: gnoi.containerz.ListVolumeResponse.options:type_name -> gnoi.containerz.ListVolumeResponse.OptionsEntry
	68, // 37: gnoi.containerz.ListVolumeResponse.labels:type_name -> gnoi.containerz.ListVolumeResponse.LabelsEntry
	71, // 38: gnoi.containerz.Plugin.hash:type_name -> gnoi.types.HashType
	48, // 39: gnoi.containerz.ListPluginsResponse.plugins:type_name -> gnoi.containerz.Plugin
	4,  // 40: gnoi.containerz.StartContainerRequest.Restart.policy:type_name -> gnoi.containerz.StartContainerRequest.Restart.Policy
	6,  // 41: gnoi.containerz.Containerz.Deploy:input_type -> gnoi.containerz.DeployRequest
	17, // 42: gnoi.containerz.Containerz.ListImage:input_type -> gnoi.containerz.ListImageRequest
	13, // 43: gnoi.containerz.Containerz.RemoveImage:input_type -> gnoi.containerz.RemoveImageRequest
	15, // 44: gnoi.containerz.Containerz.RemoveContainer:input_type -> gnoi.containerz.RemoveContainerRequest
	19, // 45: gnoi.containerz.Containerz.ListContainer:input_type -> gnoi.containerz.ListContainerRequest
	23, // 46: gnoi.containerz.Containerz.StartContainer:input_type -> gnoi.containerz.StartContainerRequest
	27, // 47: gnoi.containerz.Containerz.StopContainer:input_type -> gnoi.containerz.StopContainerRequest
	29, // 48: gnoi.containerz.Containerz.UpdateContainer:input_type -> gnoi.containerz.UpdateContainerRequest
	33, // 49: gnoi.containerz.Containerz.Log:input_type -> gnoi.containerz.LogRequest
	37, // 50: gnoi.containerz.Containerz.CreateVolume:input_type -> gnoi.containerz.CreateVolumeRequest
	39, // 51: gnoi.containerz.Containerz.RemoveVolume:input_type -> gnoi.containerz.RemoveVolumeRequest
	41, // 52: gnoi.containerz.Containerz.ListVolume:input_type -> gnoi.containerz.ListVolumeRequest
	43, // 53: gnoi.containerz.Containerz.StartPlugin:input_type -> gnoi.containerz.StartPluginRequest
	45, // 54: gnoi.containerz.Containerz.StopPlugin:input_type -> gnoi.containerz.StopPluginRequest
	47, // 55: gnoi.containerz.Containerz.ListPlugins:input_type -> gnoi.containerz.ListPluginsRequest
	50, // 56: gnoi.containerz.Containerz.RemovePlugin:input_type -> gnoi.containerz.RemovePluginRequest
	52, // 57: gnoi.containerz.Containerz.RemovePluginTar:input_type -> gnoi.containerz.RemovePluginTarRequest
	9,  // 58: gnoi.containerz.Containerz.Deploy:output_type -> gnoi.containerz.DeployResponse
	18, // 59: gnoi.containerz.Containerz.ListImage:output_type -> gnoi.containerz.ListImageResponse
	14, // 60: gnoi.containerz.Containerz.RemoveImage:output_type -> gnoi.containerz.RemoveImageResponse
	16, // 61: gnoi.containerz.Containerz.RemoveContainer:output_type -> gnoi.containerz.RemoveContainerResponse
	20, // 62: gnoi.containerz.Containerz.ListContainer:output_type -> gnoi.containerz.ListContainerResponse
	24, // 63: gnoi.containerz.Containerz.StartContainer:output_type -> gnoi.containerz.StartContainerResponse
	28, // 64: gnoi.containerz.Containerz.StopContainer:output_type -> gnoi.containerz.StopContainerResponse
	30, // 65: gnoi.containerz.Containerz.UpdateContainer:output_type -> gnoi.containerz.UpdateContainerResponse
	34, // 66: gnoi.containerz.Containerz.Log:output_type -> gnoi.containerz.LogResponse
	38, // 67: gnoi.containerz.Containerz.CreateVolume:output_type -> gnoi.containerz.CreateVolumeResponse
	40, // 68: gnoi.containerz.Containerz.RemoveVolume:output_type -> gnoi.containerz.RemoveVolumeResponse
	42, // 69: gnoi.containerz.Containerz.ListVolume:output_type -> gnoi.containerz.ListVolumeResponse
	44, // 70: gnoi.containerz.Containerz.StartPlugin:output_type -> gnoi.containerz.StartPluginResponse
	46, // 71: gnoi.containerz.Containerz.StopPlugin:output_type -> gnoi.containerz.StopPluginResponse
	49, // 72: gnoi.containerz.Containerz.ListPlugins:output_type -> gnoi.containerz.ListPluginsResponse
	51, // 73: gnoi.containerz.Containerz.RemovePlugin:output_type -> gnoi.containerz.RemovePluginResponse
	53, // 74: gnoi.containerz.Containerz.RemovePluginTar:output_type -> gnoi.containerz.RemovePluginTarResponse
