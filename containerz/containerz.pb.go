...
var file_containerz_containerz_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x5c, 0x0a, 0x0b, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x6c,
	...
	,
}
...
var file_containerz_containerz_proto_goTypes = []interface{}{
	...
	(*StartPluginRequest)(nil),                 // 44: gnoi.containerz.StartPluginRequest
	(*StartPluginResponse)(nil),                // 45: gnoi.containerz.StartPluginResponse
	(*StopPluginRequest)(nil),                  // 46: gnoi.containerz.StopPluginRequest
	(*StopPluginResponse)(nil),                 // 47: gnoi.containerz.StopPluginResponse
	(*ListPluginsRequest)(nil),                 // 48: gnoi.containerz.ListPluginsRequest
	(*Plugin)(nil),                             // 49: gnoi.containerz.Plugin
	(*ListPluginsResponse)(nil),                // 50: gnoi.containerz.ListPluginsResponse
	(*RemovePluginRequest)(nil),                // 51: gnoi.containerz.RemovePluginRequest
	(*RemovePluginResponse)(nil),               // 52: gnoi.containerz.RemovePluginResponse
	(*ListImageRequest_Filter)(nil),            // 53: gnoi.containerz.ListImageRequest.Filter
	(*ListContainerRequest_Filter)(nil),        // 54: gnoi.containerz.ListContainerRequest.Filter
	nil,                                        // 55: gnoi.containerz.ListContainerResponse.LabelsEntry
	(*StartContainerRequest_Port)(nil),         // 56: gnoi.containerz.StartContainerRequest.Port
	nil,                                        // 57: gnoi.containerz.StartContainerRequest.EnvironmentEntry
	(*StartContainerRequest_Capabilities)(nil), // 58: gnoi.containerz.StartContainerRequest.Capabilities
	(*StartContainerRequest_Restart)(nil),      // 59: gnoi.containerz.StartContainerRequest.Restart
	(*StartContainerRequest_RunAs)(nil),        // 60: gnoi.containerz.StartContainerRequest.RunAs
	nil,                                        // 61: gnoi.containerz.StartContainerRequest.LabelsEntry
	(*StartContainerRequest_Limits)(nil),       // 62: gnoi.containerz.StartContainerRequest.Limits
...
var file_containerz_containerz_proto_depIdxs = []int32{
	...
	53, // 9: gnoi.containerz.ListImageRequest.filter:type_name -> gnoi.containerz.ListImageRequest.Filter
	54, // 10: gnoi.containerz.ListContainerRequest.filter:type_name -> gnoi.containerz.ListContainerRequest.Filter
	3,  // 11: gnoi.containerz.ListContainerResponse.status:type_name -> gnoi.containerz.ListContainerResponse.Status
	55, // 12: gnoi.containerz.ListContainerResponse.labels:type_name -> gnoi.containerz.ListContainerResponse.LabelsEntry
	69, // 13: gnoi.containerz.ListContainerResponse.hash:type_name -> gnoi.types.HashType
	56, // 14: gnoi.containerz.StartContainerRequest.ports:type_name -> gnoi.containerz.StartContainerRequest.Port
	57, // 15: gnoi.containerz.StartContainerRequest.environment:type_name -> gnoi.containerz.StartContainerRequest.EnvironmentEntry
	24, // 16: gnoi.containerz.StartContainerRequest.volumes:type_name -> gnoi.containerz.Volume
	58, // 17: gnoi.containerz.StartContainerRequest.cap:type_name -> gnoi.containerz.StartContainerRequest.Capabilities
	59, // 18: gnoi.containerz.StartContainerRequest.restart:type_name -> gnoi.containerz.StartContainerRequest.Restart
	60, // 19: gnoi.containerz.StartContainerRequest.run_as:type_name -> gnoi.containerz.StartContainerRequest.RunAs
	61, // 20: gnoi.containerz.StartContainerRequest.labels:type_name -> gnoi.containerz.StartContainerRequest.LabelsEntry
	62, // 21: gnoi.containerz.StartContainerRequest.limits:type_name -> gnoi.containerz.StartContainerRequest.Limits
	...
	63, // 33: gnoi.containerz.CreateVolumeRequest.labels:type_name -> gnoi.containerz.CreateVolumeRequest.LabelsEntry
	...
	49, // 39: gnoi.containerz.ListPluginsResponse.plugins:type_name -> gnoi.containerz.Plugin
	4,  // 40: gnoi.containerz.StartContainerRequest.Restart.policy:type_name -> gnoi.containerz.StartContainerRequest.Restart.Policy
	9,  // 41: gnoi.containerz.Containerz.Deploy:input_type -> gnoi.containerz.DeployRequest
	20, // 42: gnoi.containerz.Containerz.ListImage:input_type -> gnoi.containerz.ListImageRequest
	16, // 43: gnoi.containerz.Containerz.RemoveImage:input_type -> gnoi.containerz.RemoveImageRequest
	18, // 44: gnoi.containerz.Containerz.RemoveContainer:input_type -> gnoi.containerz.RemoveContainerRequest
	22, // 45: gnoi.containerz.Containerz.ListContainer:input_type -> gnoi.containerz.ListContainerRequest
	25, // 46: gnoi.containerz.Containerz.StartContainer:input_type -> gnoi.containerz.StartContainerRequest
	29, // 47: gnoi.containerz.Containerz.StopContainer:input_type -> gnoi.containerz.StopContainerRequest
	31, // 48: gnoi.containerz.Containerz.UpdateContainer:input_type -> gnoi.containerz.UpdateContainerRequest
	35, // 49: gnoi.containerz.Containerz.Log:input_type -> gnoi.containerz.LogRequest
	38, // 50: gnoi.containerz.Containerz.CreateVolume:input_type -> gnoi.containerz.CreateVolumeRequest
	40, // 51: gnoi.containerz.Containerz.RemoveVolume:input_type -> gnoi.containerz.RemoveVolumeRequest
	42, // 52: gnoi.containerz.Containerz.ListVolume:input_type -> gnoi.containerz.ListVolumeRequest
	44, // 53: gnoi.containerz.Containerz.StartPlugin:input_type -> gnoi.containerz.StartPluginRequest
	46, // 54: gnoi.containerz.Containerz.StopPlugin:input_type -> gnoi.containerz.StopPluginRequest
	48, // 55: gnoi.containerz.Containerz.ListPlugins:input_type -> gnoi.containerz.ListPluginsRequest
	51, // 56: gnoi.containerz.Containerz.RemovePlugin:input_type -> gnoi.containerz.RemovePluginRequest
	12, // 57: gnoi.containerz.Containerz.Deploy:output_type -> gnoi.containerz.DeployResponse
	21, // 58: gnoi.containerz.Containerz.ListImage:output_type -> gnoi.containerz.ListImageResponse
	17, // 59: gnoi.containerz.Containerz.RemoveImage:output_type -> gnoi.containerz.RemoveImageResponse
	19, // 60: gnoi.containerz.Containerz.RemoveContainer:output_type -> gnoi.containerz.RemoveContainerResponse
	23, // 61: gnoi.containerz.Containerz.ListContainer:output_type -> gnoi.containerz.ListContainerResponse
	26, // 62: gnoi.containerz.Containerz.StartContainer:output_type -> gnoi.containerz.StartContainerResponse
	30, // 63: gnoi.containerz.Containerz.StopContainer:output_type -> gnoi.containerz.StopContainerResponse
	32, // 64: gnoi.containerz.Containerz.UpdateContainer:output_type -> gnoi.containerz.UpdateContainerResponse
	36, // 65: gnoi.containerz.Containerz.Log:output_type -> gnoi.containerz.LogResponse
	39, // 66: gnoi.containerz.Containerz.CreateVolume:output_type -> gnoi.containerz.CreateVolumeResponse
	41, // 67: gnoi.containerz.Containerz.RemoveVolume:output_type -> gnoi.containerz.RemoveVolumeResponse
	43, // 68: gnoi.containerz.Containerz.ListVolume:output_type -> gnoi.containerz.ListVolumeResponse
	45, // 69: gnoi.containerz.Containerz.StartPlugin:output_type -> gnoi.containerz.StartPluginResponse
	47, // 70: gnoi.containerz.Containerz.StopPlugin:output_type -> gnoi.containerz.StopPluginResponse
	50, // 71: gnoi.containerz.Containerz.ListPlugins:output_type -> gnoi.containerz.ListPluginsResponse
	52, // 72: gnoi.containerz.Containerz.RemovePlugin:output_type -> gnoi.containerz.RemovePluginResponse
