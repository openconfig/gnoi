...
const (
	...
	Containerz_RemovePluginTar_FullMethodName = "/gnoi.containerz.Containerz/RemovePluginTar"
)
...
type ContainerzClient interface {
	...
	RemovePluginTar(ctx context.Context, in *RemovePluginTarRequest, opts ...grpc.CallOption) (*RemovePluginTarResponse, error)
}
...
func (c *containerzClient) RemovePluginTar(ctx context.Context, in *RemovePluginTarRequest, opts ...grpc.CallOption) (*RemovePluginTarResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RemovePluginTarResponse)
	err := c.cc.Invoke(ctx, Containerz_RemovePluginTar_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ContainerzServer interface {
	...
	RemovePluginTar(context.Context, *RemovePluginTarRequest) (*RemovePluginTarResponse, error)
}
...
func (UnimplementedContainerzServer) RemovePluginTar(context.Context, *RemovePluginTarRequest) (*RemovePluginTarResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RemovePluginTar not implemented")
}
...
func _Containerz_RemovePluginTar_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RemovePluginTarRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ContainerzServer).RemovePluginTar(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Containerz_RemovePluginTar_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ContainerzServer).RemovePluginTar(ctx, req.(*RemovePluginTarRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Containerz_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RemovePluginTar",
			Handler:    _Containerz_RemovePluginTar_Handler,
		},
	},
