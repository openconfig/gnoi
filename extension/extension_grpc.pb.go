...
const (
	Extension_SetSignatureVerification_FullMethodName = "/gnoi.extension.Extension/SetSignatureVerification"
...
func (c *extensionClient) SetSignatureVerification(ctx context.Context, in *SigVerificationRequest, opts ...grpc.CallOption) (*SigVerificationResponse, error) {
	out := new(SigVerificationResponse)
	err := c.cc.Invoke(ctx, Extension_SetSignatureVerification_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedExtensionServer) SetSignatureVerification(context.Context, *SigVerificationRequest) (*SigVerificationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetSignatureVerification not implemented")
}
...
func _Extension_SetSignatureVerification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SigVerificationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExtensionServer).SetSignatureVerification(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Extension_SetSignatureVerification_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExtensionServer).SetSignatureVerification(ctx, req.(*SigVerificationRequest))
	}
...
var Extension_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SetSignatureVerification",
			Handler:    _Extension_SetSignatureVerification_Handler,
		},
		{
