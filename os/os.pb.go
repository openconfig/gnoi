...
func (x *InstallRequest) GetRemoteDownload() *common.RemoteDownload {
	if x != nil {
		if x, ok := x.Request.(*InstallRequest_RemoteDownload); ok {
...
type InstallRequest_RemoteDownload struct {
	RemoteDownload *common.RemoteDownload `protobuf:"bytes,4,opt,name=remote_download,json=remoteDownload,proto3,oneof"`
}
...
func (*InstallRequest_RemoteDownload) isInstallRequest_Request() {}
...
const file_github_com_openconfig_gnoi_os_os_proto_rawDesc = "" +
	"\n" +
	"&github.com/openconfig/gnoi/os/os.proto\x12\agnoi.os\x1a6github.com/openconfig/gnoi/bootconfig/bootconfig.proto\x1a,github.com/openconfig/gnoi/types/types.proto\x1a.github.com/openconfig/gnoi/common/common.proto\"\x92\x02\n" +
	...
	"\ftransfer_end\x18\x03 \x01(\v2\x14.gnoi.os.TransferEndH\x00R\vtransferEnd\x12F\n" +
	"\x0fremote_download\x18\x04 \x01(\v2\x1b.gnoi.common.RemoteDownloadH\x00R\x0eremoteDownloadB\t\n" +
	"\arequest\"}\n" +
...
var file_github_com_openconfig_gnoi_os_os_proto_goTypes = []any{
	...
	(*common.RemoteDownload)(nil),           // 21: gnoi.common.RemoteDownload
	(*bootconfig.SetBootConfigRequest)(nil), // 22: gnoi.bootconfig.SetBootConfigRequest
}
var file_github_com_openconfig_gnoi_os_os_proto_depIdxs = []int32{
	...
	21, // 2: gnoi.os.InstallRequest.remote_download:type_name -> gnoi.common.RemoteDownload
	7,  // 3: gnoi.os.InstallResponse.transfer_ready:type_name -> gnoi.os.TransferReady
	8,  // 4: gnoi.os.InstallResponse.transfer_progress:type_name -> gnoi.os.TransferProgress
	9,  // 5: gnoi.os.InstallResponse.sync_progress:type_name -> gnoi.os.SyncProgress
	10, // 6: gnoi.os.InstallResponse.validated:type_name -> gnoi.os.Validated
	11, // 7: gnoi.os.InstallResponse.install_error:type_name -> gnoi.os.InstallError
	0,  // 8: gnoi.os.InstallError.type:type_name -> gnoi.os.InstallError.Type
	22, // 9: gnoi.os.ActivateRequest.boot_config:type_name -> gnoi.bootconfig.SetBootConfigRequest
	14, // 10: gnoi.os.ActivateResponse.activate_ok:type_name -> gnoi.os.ActivateOK
	15, // 11: gnoi.os.ActivateResponse.activate_error:type_name -> gnoi.os.ActivateError
	1,  // 12: gnoi.os.ActivateError.type:type_name -> gnoi.os.ActivateError.Type
	18, // 13: gnoi.os.VerifyResponse.verify_standby:type_name -> gnoi.os.VerifyStandby
	19, // 14: gnoi.os.VerifyStandby.standby_state:type_name -> gnoi.os.StandbyState
	20, // 15: gnoi.os.VerifyStandby.verify_response:type_name -> gnoi.os.StandbyResponse
	2,  // 16: gnoi.os.StandbyState.state:type_name -> gnoi.os.StandbyState.State
	3,  // 17: gnoi.os.OS.Install:input_type -> gnoi.os.InstallRequest
	12, // 18: gnoi.os.OS.Activate:input_type -> gnoi.os.ActivateRequest
	16, // 19: gnoi.os.OS.Verify:input_type -> gnoi.os.VerifyRequest
	6,  // 20: gnoi.os.OS.Install:output_type -> gnoi.os.InstallResponse
	13, // 21: gnoi.os.OS.Activate:output_type -> gnoi.os.ActivateResponse
	17, // 22: gnoi.os.OS.Verify:output_type -> gnoi.os.VerifyResponse
...
func file_github_com_openconfig_gnoi_os_os_proto_init() {
	...
	file_github_com_openconfig_gnoi_os_os_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*InstallRequest_RemoteDownload)(nil),
	}
