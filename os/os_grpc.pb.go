...
func (c *oSClient) Install(ctx context.Context, opts ...grpc.CallOption) (OS_InstallClient, error) {
	stream, err := c.cc.NewStream(ctx, &OS_ServiceDesc.Streams[0], OS_Install_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *oSClient) Activate(ctx context.Context, in *ActivateRequest, opts ...grpc.CallOption) (*ActivateResponse, error) {
	...
	err := c.cc.Invoke(ctx, OS_Activate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *oSClient) Verify(ctx context.Context, in *VerifyRequest, opts ...grpc.CallOption) (*VerifyResponse, error) {
	...
	err := c.cc.Invoke(ctx, OS_Verify_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedOSServer should be embedded to have forward compatible implementations.
