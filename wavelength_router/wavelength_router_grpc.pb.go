...
func (c *wavelengthRouterClient) AdjustPSD(ctx context.Context, in *AdjustPSDRequest, opts ...grpc.CallOption) (WavelengthRouter_AdjustPSDClient, error) {
	stream, err := c.cc.NewStream(ctx, &WavelengthRouter_ServiceDesc.Streams[0], WavelengthRouter_AdjustPSD_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *wavelengthRouterClient) CancelAdjustPSD(ctx context.Context, in *AdjustPSDRequest, opts ...grpc.CallOption) (*CancelAdjustPSDResponse, error) {
	...
	err := c.cc.Invoke(ctx, WavelengthRouter_CancelAdjustPSD_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wavelengthRouterClient) AdjustSpectrum(ctx context.Context, in *AdjustSpectrumRequest, opts ...grpc.CallOption) (WavelengthRouter_AdjustSpectrumClient, error) {
	stream, err := c.cc.NewStream(ctx, &WavelengthRouter_ServiceDesc.Streams[1], WavelengthRouter_AdjustSpectrum_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *wavelengthRouterClient) CancelAdjustSpectrum(ctx context.Context, in *AdjustSpectrumRequest, opts ...grpc.CallOption) (*CancelAdjustSpectrumResponse, error) {
	...
	err := c.cc.Invoke(ctx, WavelengthRouter_CancelAdjustSpectrum_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedWavelengthRouterServer should be embedded to have forward compatible implementations.
