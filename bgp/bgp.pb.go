...
const (
	...
	// Deprecated: Marked as deprecated in github.com/openconfig/gnoi/bgp/bgp.proto.
	ClearBGPNeighborRequest_HARD           ClearBGPNeighborRequest_Mode = 2
	ClearBGPNeighborRequest_HARD_RESET     ClearBGPNeighborRequest_Mode = 3
	ClearBGPNeighborRequest_GRACEFUL_RESET ClearBGPNeighborRequest_Mode = 4
)
...
const file_github_com_openconfig_gnoi_bgp_bgp_proto_rawDesc = "" +
	"\n" +
	"(github.com/openconfig/gnoi/bgp/bgp.proto\x12\bgnoi.bgp\x1a,github.com/openconfig/gnoi/types/types.proto\"\xea\x01\n" +
	"\x17ClearBGPNeighborRequest\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\x12)\n" +
	"\x10routing_instance\x18\x02 \x01(\tR\x0froutingInstance\x12:\n" +
	"\x04mode\x18\x03 \x01(\x0e2&.gnoi.bgp.ClearBGPNeighborRequest.ModeR\x04mode\"N\n" +
	"\x04Mode\x12\b\n" +
	"\x04SOFT\x10\x00\x12\n" +
	"\n" +
	"\x06SOFTIN\x10\x01\x12\f\n" +
	"\x04HARD\x10\x02\x1a\x02\b\x01\x12\x0e\n" +
	"\n" +
	"HARD_RESET\x10\x03\x12\x12\n" +
	"\x0eGRACEFUL_RESET\x10\x04\"\x1a\n" +
