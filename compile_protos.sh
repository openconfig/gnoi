...
# Go
for p in types common containerz debug diag extension bgp cert factory_reset file healthz layer2 mpls system os otdr wavelength_router packet_link_qualification; do
