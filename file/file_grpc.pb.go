...
func (c *fileClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (File_GetClient, error) {
	stream, err := c.cc.NewStream(ctx, &File_ServiceDesc.Streams[0], File_Get_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *fileClient) TransferToRemote(ctx context.Context, in *TransferToRemoteRequest, opts ...grpc.CallOption) (*TransferToRemoteResponse, error) {
	...
	err := c.cc.Invoke(ctx, File_TransferToRemote_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fileClient) Put(ctx context.Context, opts ...grpc.CallOption) (File_PutClient, error) {
	stream, err := c.cc.NewStream(ctx, &File_ServiceDesc.Streams[1], File_Put_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *fileClient) Remove(ctx context.Context, in *RemoveRequest, opts ...grpc.CallOption) (*RemoveResponse, error) {
	...
	err := c.cc.Invoke(ctx, File_Remove_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
