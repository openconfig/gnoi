...
const (
	...
	System_Probe_FullMethodName                  = "/gnoi.system.System/Probe"
...
type SystemClient interface {
	...
	Probe(ctx context.Context, in *ProbeRequest, opts ...grpc.CallOption) (System_ProbeClient, error)
...
func (c *systemClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (System_PingClient, error) {
	stream, err := c.cc.NewStream(ctx, &System_ServiceDesc.Streams[0], System_Ping_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *systemClient) Probe(ctx context.Context, in *ProbeRequest, opts ...grpc.CallOption) (System_ProbeClient, error) {
	stream, err := c.cc.NewStream(ctx, &System_ServiceDesc.Streams[1], System_Probe_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &systemProbeClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type System_ProbeClient interface {
...
func (x *systemProbeClient) Recv() (*ProbeResponse, error) {
	m := new(ProbeResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *systemClient) Traceroute(ctx context.Context, in *TracerouteRequest, opts ...grpc.CallOption) (System_TracerouteClient, error) {
	stream, err := c.cc.NewStream(ctx, &System_ServiceDesc.Streams[2], System_Traceroute_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *systemClient) Time(ctx context.Context, in *TimeRequest, opts ...grpc.CallOption) (*TimeResponse, error) {
	...
	err := c.cc.Invoke(ctx, System_Time_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *systemClient) SetPackage(ctx context.Context, opts ...grpc.CallOption) (System_SetPackageClient, error) {
	stream, err := c.cc.NewStream(ctx, &System_ServiceDesc.Streams[3], System_SetPackage_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *systemClient) SwitchControlProcessor(ctx context.Context, in *SwitchControlProcessorRequest, opts ...grpc.CallOption) (*SwitchControlProcessorResponse, error) {
	...
	err := c.cc.Invoke(ctx, System_SwitchControlProcessor_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *systemClient) Reboot(ctx context.Context, in *RebootRequest, opts ...grpc.CallOption) (*RebootResponse, error) {
	...
	err := c.cc.Invoke(ctx, System_Reboot_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *systemClient) RebootStatus(ctx context.Context, in *RebootStatusRequest, opts ...grpc.CallOption) (*RebootStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, System_RebootStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *systemClient) CancelReboot(ctx context.Context, in *CancelRebootRequest, opts ...grpc.CallOption) (*CancelRebootResponse, error) {
	...
	err := c.cc.Invoke(ctx, System_CancelReboot_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *systemClient) KillProcess(ctx context.Context, in *KillProcessRequest, opts ...grpc.CallOption) (*KillProcessResponse, error) {
	...
	err := c.cc.Invoke(ctx, System_KillProcess_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SystemServer interface {
	...
	// streams back the results.  Some targets may not stream any results
	// until all results are in.
	Probe(*ProbeRequest, System_ProbeServer) error
	// Traceroute executes the traceroute command on the target and streams back
	// the results.  Some targets may not stream any results until all
	// results are in.  If a hop count is not explicitly provided,
	// 30 is used.
...
func (UnimplementedSystemServer) Probe(*ProbeRequest, System_ProbeServer) error {
	return status.Errorf(codes.Unimplemented, "method Probe not implemented")
}
...
func _System_Probe_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ProbeRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(SystemServer).Probe(m, &systemProbeServer{stream})
}

type System_ProbeServer interface {
...
func (x *systemProbeServer) Send(m *ProbeResponse) error {
	return x.ServerStream.SendMsg(m)
}
