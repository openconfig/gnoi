...
func (c *systemClient) Traceroute(ctx context.Context, in *TracerouteRequest, opts ...grpc.CallOption) (System_TracerouteClient, error) {
	stream, err := c.cc.NewStream(ctx, &System_ServiceDesc.Streams[1], System_Traceroute_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *systemClient) SetPackage(ctx context.Context, opts ...grpc.CallOption) (System_SetPackageClient, error) {
	stream, err := c.cc.NewStream(ctx, &System_ServiceDesc.Streams[2], System_SetPackage_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
